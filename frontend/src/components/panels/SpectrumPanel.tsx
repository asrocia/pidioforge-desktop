  ...
  return (
    <aside className="flex flex-col h-full bg-[var(--primary-bg)] overflow-hidden">
      ...
      <div className="flex items-center justify-between px-5 py-4 border-b border-[var(--border-subtle)]">
        <div>
          <h2 className="text-[18px] font-bold text-[var(--text-primary)]">Spectrum Visualizer</h2>
          <p className="text-[12px] text-[var(--text-muted)] mt-1">Audio spectrum, waveform, dan now playing</p>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-5 py-4 space-y-4">
        ...
        <div className="space-y-3 p-4 bg-[var(--secondary-bg)] border border-[var(--border-subtle)] rounded-[var(--radius-lg)]">
          <h3 className="text-[13px] font-bold text-[var(--text-primary)] mb-3">Media Utama</h3>
          ...
          <div className="flex items-start gap-2 px-3 py-2 bg-[var(--tertiary-bg)] border border-[var(--border-subtle)] rounded-[var(--radius-md)] text-[11px] text-[var(--text-muted)]">
            ...
            <span>Geser teks atau spektrum langsung di pratinjau. Klik teks Now Playing untuk mengubah judul.</span>
          </div>
        </div>

        {/* Visualizer */}
        <div className="space-y-3 p-4 bg-[var(--secondary-bg)] border border-[var(--border-subtle)] rounded-[var(--radius-lg)]">
          <h3 className="text-[13px] font-bold text-[var(--text-primary)] mb-3">Visualizer</h3>
        ...
        {/* Particle Effects */}
        <div className="space-y-3 p-4 bg-[var(--secondary-bg)] border border-[var(--border-subtle)] rounded-[var(--radius-lg)]">
          <h3 className="text-[13px] font-bold text-[var(--text-primary)] mb-3">Particle Effects</h3>
          ...
          <Slider label="Particle Size" value={Number(getDeep(config, 'spectrum.particles.size', 8))} onChange={v => updateConfig('spectrum.particles.size', v)} min={4} max={32} />
          <Slider label="Particle Speed" value={Number(getDeep(config, 'spectrum.particles.speed', 50))} onChange={v => updateConfig('spectrum.particles.speed', v)} min={10} max={100} />
          <Slider label="Lifetime (seconds)" value={Number(getDeep(config, 'spectrum.particles.lifetime', 3))} onChange={v => updateConfig('spectrum.particles.lifetime', v)} min={1} max={10} />
        ...
        {/* Warna & Reaksi Beat */}
        <div className="space-y-3 p-4 bg-[var(--secondary-bg)] border border-[var(--border-subtle)] rounded-[var(--radius-lg)]">
          <h3 className="text-[13px] font-bold text-[var(--text-primary)] mb-3">Warna & Reaksi Beat</h3>
          <div className="grid grid-cols-3 gap-3">
        ...
        {/* Progress */}
        <div className="space-y-3 p-4 bg-[var(--secondary-bg)] border border-[var(--border-subtle)] rounded-[var(--radius-lg)]">
          <h3 className="text-[13px] font-bold text-[var(--text-primary)] mb-3">Progress</h3>
        ...
        <div className="space-y-3 p-4 bg-[var(--secondary-bg)] border border-[var(--border-subtle)] rounded-[var(--radius-lg)]">
          <h3 className="text-[13px] font-bold text-[var(--text-primary)] mb-3">Logo/Watermark Overlay</h3>
          ...
          <Slider label="Padding (px)" value={Number(getDeep(config, 'spectrum.logo.padding', 20))} onChange={v => updateConfig('spectrum.logo.padding', v)} min={0} max={100} />
        ...
        {/* Info Lagu */}
        <div className="space-y-3 p-4 bg-[var(--secondary-bg)] border border-[var(--border-subtle)] rounded-[var(--radius-lg)]">
          <h3 className="text-[13px] font-bold text-[var(--text-primary)] mb-3">Info Lagu</h3>
          ...
          <div className="mt-3 p-3 bg-[var(--tertiary-bg)] border border-[var(--border-subtle)] rounded-[var(--radius-md)] space-y-3">
            ...
            <Slider label="Shadow Blur" value={Number(getDeep(config, 'spectrum.nowPlayingShadowBlur', 4))} onChange={v => updateConfig('spectrum.nowPlayingShadowBlur', v)} min={0} max={20} />
          ...
          <div className="flex items-start gap-2 px-3 py-2 bg-[var(--tertiary-bg)] border border-[var(--border-subtle)] rounded-[var(--radius-md)] text-[11px] text-[var(--text-muted)]">
            <span className="text-[var(--accent-primary)]">💡</span>
            <span>Variable template: {'{title}'}, {'{artist}'}, {'{album}'}, {'{filename}'}</span>
          </div>
        </div>
      </div>
    </aside>

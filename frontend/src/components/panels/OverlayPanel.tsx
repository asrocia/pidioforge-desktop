  ...
  return (<div className="space-y-4">
        ...
        <div className="p-4 bg-[var(--secondary-bg)] border border-[var(--border-subtle)] rounded-[var(--radius-lg)] space-y-3">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <button onClick={() => applyOverlayFormatPreset(updateConfig, format)} className="px-3 py-1.5 text-[11px] font-semibold text-[var(--text-primary)] bg-[var(--tertiary-bg)] hover:bg-[var(--tertiary-bg)]/80 border border-[var(--border-subtle)] rounded-[var(--radius-md)] transition-all duration-200">Format {format === 'vertical' ? '9:16' : format === 'square' ? '1:1' : '16:9'}</button>
            <button onClick={validateOverlay} disabled={busy} className="px-3 py-1.5 text-[11px] font-semibold text-white bg-[var(--accent-primary)] hover:bg-[var(--accent-primary)]/90 disabled:opacity-50 disabled:cursor-not-allowed rounded-[var(--radius-md)] transition-all duration-200">Cek Overlay</button>
          </div>
          {message && (
          ...
          {validation?.warnings?.length ? (
            <div className="p-3 bg-[var(--secondary-bg)] border-l-4 border-[var(--accent-warning)] rounded-[var(--radius-lg)]">
              <h4 className="text-[11px] font-bold text-[var(--accent-warning)] mb-2">⚠ Catatan overlay:</h4>

...
export const defaultConfig = {
  ...
  input: {
    ...
    autoPairByName: true,
    pairMode: 'by-name',
    excludeOutputOnScan: true,
    ignoreWords: 'official,lyrics,lyric,visual,full,hd,video,audio,music',
  },
  branding: {
    bumperVideo: '',
    bumperEnabled: false,
    bumperPosition: 'Akhir',
    bumperTransition: 'fade',
    bumperDuration: 3,
    bumperFadeDuration: 0.45,
    bumperAudioMode: 'after-intro',
    logo: '',
    logoEnabled: true,
    ...
    ctaAt: 2,
    ctaDuration: 8,
    ctaChromaPreset: 'green',
    ctaChromaColor: '0x00ff00',
    ctaSimilarity: 0.35,
    ctaBlend: 0.08,
    watermarkText: '',
  ...
  spectrum: {
    enabled: true,
    model: 'Bar',
    analyzerMode: 'frequency',
    stylePreset: 'clean-wave',
    mirror: 'Off',
    position: 'Bawah',
    zoom: 100,
    crop: 0,
    ...
    nowPlayingArtist: '',
    nowPlayingAlbum: '',
    nowPlayingAutoFromFile: true,
    beatReactive: true,
    beatSensitivity: 55,
    autoTune: true,
    smoothing: 45,
    gain: 1.0,
    analyzerQuality: 'balanced',
    gallery: {
      enabled: false,
      images: [],
      activeIndex: 0,
...
export const socialPresets = [
  {
    id: 'preset-youtube-720',
    name: 'YouTube HD Ringan 720p',
    config: {
      target: { resolution: '1280x720', width: 1280, height: 720, bitrate: '4500k', quality: 'balanced', fps: 30 },
    },
  },
  {
    id: 'preset-youtube-1080',
    name: 'YouTube Full HD 1080p',
    config: {
      target: { resolution: '1920x1080', width: 1920, height: 1080, bitrate: '8000k', quality: 'high', fps: 30 },
    },
  },
  {
    id: 'preset-shorts',
    ...
    config: {
      target: { resolution: '1080x1920', width: 1080, height: 1920, bitrate: '7000k', quality: 'balanced', fps: 30 },
    },
  },
  {
    id: 'preset-square',
    name: 'Square Feed 1080x1080',
    config: {
      target: { resolution: '1080x1080', width: 1080, height: 1080, bitrate: '6000k', quality: 'balanced', fps: 30 },
    },
  },
  {
    id: 'preset-fast',
    name: 'Thumbnail / Preview Cepat',
    config: { target: { quality: 'fast', bitrate: '2500k', fps: 24 } },
  },
];
